...
classDiagram
    ...
    Dwelling ..|> IOwner : реализует
    Mine ..|> IOwner : реализует
    Mine ..|> IArmy : реализует
    Mine ..|> ITreasure : реализует
    Creeps ..|> IArmy : реализует
    Creeps ..|> ITreasure : реализует
    Wolves ..|> IArmy : реализует
    ResourcePile ..|> ITreasure : реализует
